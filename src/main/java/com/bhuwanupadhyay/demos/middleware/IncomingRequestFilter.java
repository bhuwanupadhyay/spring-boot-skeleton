package com.bhuwanupadhyay.demos.middleware;

import com.bhuwanupadhyay.demos.AppProperties;
import com.bhuwanupadhyay.demos.model.AppHeaders;
import com.bhuwanupadhyay.demos.model.AppLogger;
import com.bhuwanupadhyay.demos.model.Request;
...
public class IncomingRequestFilter implements Filter {
    ...
    public IncomingRequestFilter(
        ...
        this.logger = logger;
        this.allowOriginDomains = properties.getCorsAllowOrigins();
    }
